...
def main():
    ...
    for root, dirnames, filenames in os.walk(filepath):
        for filename in fnmatch.filter(filenames, '*.png'):
            ...
            total_benign_value = 0
            total_malignant_value = 0
            for prediction in predictions:
                total_benign_value += prediction[0][0]
                total_malignant_value += prediction[0][1]

            model1_prediction[0][0] = model1_prediction[0][0]/total_benign_value
            model2_prediction[0][0] = model2_prediction[0][0]/total_benign_value
            model3_prediction[0][0] = model3_prediction[0][0]/total_benign_value
            model4_prediction[0][0] = model4_prediction[0][0]/total_benign_value
            model5_prediction[0][0] = model5_prediction[0][0]/total_benign_value
            model6_prediction[0][0] = model6_prediction[0][0]/total_benign_value
            model7_prediction[0][0] = model7_prediction[0][0]/total_benign_value
            model8_prediction[0][0] = model8_prediction[0][0]/total_benign_value

            model1_prediction[0][1] = model1_prediction[0][1]/total_malignant_value
            model2_prediction[0][1] = model2_prediction[0][1]/total_malignant_value
            model3_prediction[0][1] = model3_prediction[0][1]/total_malignant_value
            model4_prediction[0][1] = model4_prediction[0][1]/total_malignant_value
            model5_prediction[0][1] = model5_prediction[0][1]/total_malignant_value
            model6_prediction[0][1] = model6_prediction[0][1]/total_malignant_value
            model7_prediction[0][1] = model7_prediction[0][1]/total_malignant_value
            model8_prediction[0][1] = model8_prediction[0][1]/total_malignant_value
            ...
            for prediction in predictions:
                if np.argmax(prediction, axis=0)==0:
