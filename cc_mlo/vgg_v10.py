...
with central_storage_strategy.scope():
        ...
        model_results = model_0.fit(traindataimages, batch_size=4, epochs=125, validation_data=testdataimages, validation_batch_size=4, validation_steps=250, callbacks=[checkpoint])
