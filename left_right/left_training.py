...
traindata = trdata.flow_from_directory(directory="/home-1/aeshak1@jhu.edu/scratch/left-right/left/training", target_size=(2900,4000), batch_size=1,color_mode='grayscale')
...
with central_storage_strategy.scope():
        ...
        checkpoint = ModelCheckpoint("cc_best_model4.hdf5", monitor='accuracy', verbose=1, save_best_only=True, mode='auto', period=1)
        # Compile the model
...
#
test_images = trdata.flow_from_directory(directory="/home-1/aeshak1@jhu.edu/scratch/left-right/left/test",batch_size=1, target_size=(2900,4000), color_mode='rgb')
