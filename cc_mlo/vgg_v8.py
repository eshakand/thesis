...
with central_storage_strategy.scope():
        ...
        model_results = model_0.fit(traindataimages, batch_size=4, epochs=125, validation_data=testdataimages, validation_batch_size=1, validation_steps=25, validation_freq=5, callbacks=[checkpoint])
