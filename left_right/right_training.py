...
traindata = trdata.flow_from_directory(directory="/home-1/aeshak1@jhu.edu/scratch/cc-mlo/cc/trainnig/", target_size=(2900,4000), batch_size=1,color_mode='grayscale')
...
#
test_images = trdata.flow_from_directory(directory="/home-1/aeshak1@jhu.edu/scratch/cc-mlo/cc/test/",batch_size=1, target_size=(2900,4000), color_mode='rgb')
